...
public class Participant {
	...
	private LocalDateTime registeredTime;        // 참가자가 스터디룸에 최초로 등록된 시간
	...
	public ParticipantResponse getParticipant() {
		return new ParticipantResponse(getParticipantPK().getUsersSeq(), getNickname(), getStatus(), getAttend(),
			getCatSkin(), getCategoriesName(), getRegisteredTime());
	}
