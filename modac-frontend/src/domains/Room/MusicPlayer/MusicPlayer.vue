...
<script setup>
  ...
  //   prev.value = document.querySelector(".prev");
  //   playPause.value = document.querySelector(".playPause");
  //   next.value = document.querySelector(".next");
  ...
  function loadSong(songList){
    ...
    const audio = new Audio(songList.path);
    audio.play()
  }
